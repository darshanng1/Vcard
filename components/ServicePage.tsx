  ...
  return (
    <article className="pb-40 bg-slate-950 text-slate-200 min-h-screen overflow-y-auto no-scrollbar relative">
      ...
      <header className="px-10 pt-24 mb-20 relative z-10 text-center">
        <div className="text-9xl mb-12 drop-shadow-[0_0_50px_rgba(16,185,129,0.3)]">{service.icon}</div>
      ...
      <div className="px-10 space-y-24 max-w-[500px] mx-auto relative z-10">
        ...
        <section className="industrial-border pl-8 border-emerald-500/20">
          <h2 className="text-[10px] font-black uppercase tracking-[0.6em] text-zinc-700 mb-10 border-b border-white/5 pb-4">The Problem</h2>
          <div className="space-y-8">
            ...
            <div className="glass p-8 rounded-[2rem] border-emerald-500/10">
              ...
              <p className="text-slate-500 text-sm leading-relaxed italic">{service.inspection}</p>
            </div>
          </div>
        </section>
        ...
        {/* PROCESS */}
        <section className="industrial-border pl-8 border-emerald-500/20">
          <h2 className="text-[10px] font-black uppercase tracking-[0.6em] text-zinc-700 mb-10 border-b border-white/5 pb-4">Our Approach</h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              {service.applications.map((app, i) => (
                <div key={i} className="glass p-5 rounded-2xl border border-white/5 flex items-center space-x-3">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-slate-500 leading-none">{app}</span>
                </div>
              ))}
            </div>
        ...
        {/* FAQ */}
        <section className="industrial-border pl-8 border-emerald-500/20">
          <h2 className="text-[10px] font-black uppercase tracking-[0.6em] text-zinc-700 mb-12 border-b border-white/5 pb-4">Common Questions</h2>
          <div className="space-y-12">
            {service.faqs.map((faq, i) => (
              <div key={i} className="border-b border-white/5 pb-10 last:border-none">
                <h3 className="font-black text-white text-[12px] uppercase tracking-widest mb-6 leading-relaxed">{faq.question}</h3>
        ...
        <section className="pt-20 pb-40">
          <Link to="/book" className="block w-full bg-emerald-600 text-white py-7 rounded-[2rem] text-center font-black text-[12px] uppercase tracking-[0.5em] active:scale-95 transition-all shadow-2xl hover:bg-emerald-500">
            Book Inspection
          </Link>
          <div className="mt-12 flex flex-col items-center space-y-4">
            <p className="text-[9px] text-slate-700 font-black uppercase tracking-[0.8em]">
